                ...
                <div class="carousel-item active">
                  <div class="containr">
                    <div class="text-contet">
                      <h2>Data Science, ML, and AI Training</h2>
                      <p>
                        Master the skills of Data Science, Machine Learning, and
                        Artificial Intelligence! Hands-on projects,
                        industry-relevant tools, and expert mentorship. Ideal
                        for beginners and professionals looking to advance their careers.
                    ...
                    <div class="carousl">
                      <img alt="Java Full Stack Training and Certification icons" height="450" src="assets/images/slider/arti.png" width="450"/>
                    </div>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="containr">
                    <div class="text-contet">
                      ...
                      <p>
                        Learn cutting-edge AI techniques and tools.<br> Real-world
                        applications, live projects, and job assistance included.
                      </p>
                    ...
                    <div class="carousl">
                      <img alt="Advanced Java Full Stack Training" height="450" src="assets/images/slider/machine.png" width="450"/>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Course Details Section -->
	<div class="container mt-5">
		<h2 class="text-center mb-4" style="font-weight:bold">Data Science, AI and ML Course
			Details</h2>
		<div class="row">
			<div class="col-md-6">
				<h3 style="font-weight:bold">Course Overview</h3>
				<p>This comprehensive program equips you with the skills and
					tools required to excel in the fields of Data Science, Machine
					Learning, and Artificial Intelligence.</p>
				<ul>
					<li>In-depth training in data preprocessing, modeling, and
						deployment.</li>
			...
			<div class="col-md-6">
				...
				<p>We offer expert trainers, flexible learning options, and a
					focus on your career success.</p>
				<ul>
					<li>Learn from experienced industry professionals.</li>
					<li>Placement assistance and career counseling included.</li>
					<li>Work on live projects to boost your practical knowledge.</li>
				</ul>
			</div>
		</div>
		<hr class="my-5">
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 1: Data Analysis and
							Visualization</h5>
						<p class="card-text">Learn to preprocess and visualize data
							using tools like Pandas, NumPy, and Matplotlib.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 2: Machine Learning</h5>
						<p class="card-text">Master supervised and unsupervised
							learning algorithms and deployment strategies.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 3: Artificial Intelligence</h5>
						<p class="card-text">Delve into AI concepts, including neural
							networks, NLP, and computer vision.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section style="background-color: #0274be; padding: 20px; margin-top:20px">
        <div class="container-fluid">
            <!-- <div class="row"> -->
                <!-- Left Section: Data Sceince Table -->
                ...
                <div class="col-lg-full col-md-full col-sm-full mb-3">
                    <div class="bg-white p-3 rounded shadow-sm">
                        <h2 class="text-center mb-4" style="color: black; font-weight: bold; margin-top: 20px;">
                            Plenary for Data Science, AI and ML Certification Training
                        </h2>
