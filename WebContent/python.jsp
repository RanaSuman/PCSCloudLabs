            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="containr">
                    <div class="text-contet">
                      <h2>Python Training & Certification</h2>
                      <p>
                        Master Python programming with comprehensive, hands-on training!
                        Real-world projects, job assistance, and expert mentorship.
                        Suitable for beginners and professionals.<br> Trusted by
                    ...
                    <div class="carousl">
                      <img alt="Java Full Stack Training and Certification icons" height="450" src="assets/images/slider/pyth.png" width="450"/>
                    </div>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="containr">
                    <div class="text-contet">
                      <h2>Advanced Python Techniques</h2>
                      <p>
                        Become proficient in Python for Data Science, AI, and Web
                        Development. Live projects and industry-relevant
                        training included.
                    ...
                    <div class="carousl">
                      <img alt="Advanced Java Full Stack Training" height="450" src="assets/images/slider/pyth.png" width="450"/>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Course Details Section -->
	<div class="container mt-5">
		<h2 class="text-center mb-4" style="font-weight:bold">Python Course Details</h2>
		<div class="row">
			<div class="col-md-6">
				<h3 style="font-weight:bold">Course Overview</h3>
				<p>Our Python training program is designed to equip you with the
					skills and knowledge required to excel in various Python
					applications.</p>
				<ul>
					<li>Comprehensive training for Python fundamentals and
						advanced topics.</li>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 1: Python Basics</h5>
						<p class="card-text">Learn the fundamentals of Python,
							including syntax, variables, and data structures.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 2: Advanced Python</h5>
						<p class="card-text">Master advanced concepts like OOP, file
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold" >Module 3: Python for Data Science</h5>
						<p class="card-text">Dive into Python libraries for data
							analysis, visualization, and machine learning.</p>
					</div>
				</div>
			</div>
		</div>
