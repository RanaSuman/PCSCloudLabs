	...
	<div class="container mt-5">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>Our DevOps training program is designed to equip you with the
					skills and knowledge required to excel in the DevOps ecosystem.</p>
				<ul>
					<li>Comprehensive training for DevOps Admin and Developer
						roles.</li>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 1: DevOps Basics</h5>
						<p class="card-text">Learn the fundamentals of DevOps,
							including CRM basics and platform overview.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card" >
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 2: DevOps Administration</h5>
						<p class="card-text">Master administrative tasks such as user
							management, workflows, and security settings.</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
					<div class="card-body" style="color:black">
						<h5 class="card-title" style="font-weight:bold">Module 3: DevOps Development</h5>
						<p class="card-text">Advance your development skills with
							DevOps Docker, Kubernetes, CI/CD and Lightning.</p>
					</div>
				</div>
			</div>
		</div>
