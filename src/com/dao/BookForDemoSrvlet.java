...
public class BookForDemoSrvlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    if (!verify) {
	        ...
	        resp.sendRedirect("demobook.jsp");
	        return;
	    }
		...
		try {
			...
			/*
			 * String sql = "SELECT * FROM user WHERE email = ?"; PreparedStatement pst =
			 * connection.prepareStatement(sql); pst.setString(1, email);
			 * 
			 ...
			 */
				...
				if(noOfRows > 0) {
					...
					req.getSession().setAttribute("emailmessage", success);
					req.getSession().setAttribute("demomessage", "You succussfully registered for Demo class");
            ...
            req.getSession().setAttribute("demomessage", "An error occurred while booking your demo. Please try again later.");
            req.getSession().setAttribute("demomessagecolor", "red");
            resp.sendRedirect("index.jsp");
		}finally {
